    ...
    <>
      ...
      >
        <div className="terms-of-service">
          ...
          <p>
            The project's invoicing will be as follows: 50% deposit on order,
            40% on delivery of panels and inverters to site and 10% on project
            handover certificate sign off. Prices are valid to {priceValidUntil}
            . Thereafter, prices may change due to exchange rate fluctuations,
            inflation (CPI) and/or supplier price changes. Invoices will be paid
            on 7 days terms. Late delivery penalty due to delays caused by the
            contractor will be 0.5% of project value per week.
          </p>
        ...
        <ol className="ps-4">
          ...
          <li>
            ...
            <ol type="a" className="ps-4">
              ...
              <li>
                No cost for building an inverter enclosure has been included.
              </li>
              <li>
              ...
              <li>
                No costs have been allowed for storage and safekeeping of
                equipment and materials once delivered to site.
              </li>
            </ol>
          </li>
          <li>
