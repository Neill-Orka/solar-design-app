    ...
    return (
        <section className={`orka-standard-page ${className}`}>
            ...
            <div className="orka-summary-headerbar">
                <div className="orka-summary-project">{project.name} - {displayValue(project.inverter_kva, "0", "inverter_kva")} kVA {Number(displayValue(project.battery_kwh, "0", "battery_kwh")) > 0 && `& ${displayValue(project.battery_nominal_rating, "0", "battery_kwh")} kWh`}</div>
