...
const SizingView = ({
  ...
  const persistPanel = async (panelId, panelKw, numPanels) => {
    try {
      ...
      if (showNotification)
        showNotification("Failed to save panel selection", "danger");
    }
  };
  ...
  const handleTargetKwChange = async (e) => {
    ...
    const panelWattage =
      design.selectedPanel?.product?.power_w || PANEL_WATTAGE;
    const newNumPanels =
      kw && parseFloat(kw) > 0
        ? Math.max(
            1,
            Math.ceil(
              Math.round(parseFloat(kw) * 1000 * 100) / 100 / panelWattage
            )
          )
        : "";
  ...
  const handleNumPanelsChange = async (e) => {
    ...
    const panelWattage =
      design.selectedPanel?.product?.power_w || PANEL_WATTAGE;
    const newKw =
      panels && parseInt(panels) > 0
        ? ((parseInt(panels) * panelWattage) / 1000).toFixed(2)
        : "";
  ...
  const handleSelectChange = async (key, selectedOption) => {
    ...
    const productObject = productList.find(
      (p) => p.id === selectedOption.value
    );
    const next = productObject
      ? { ...selectedOption, product: productObject }
      : null;
    ...
    if (key === "selectedPanel") {
      ...
      const recomputedKw =
        qty > 0 ? ((qty * watt) / 1000).toFixed(2) : design.panelKw || 0;
            ...
            <Card.Body className="d-flex flex-column">
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Check
                  ...
                  label={
                    usePvgis
                      ? "Live PVGIS Data (Slow)"
                      : "Standard Profile (Fast)"
                  }
                  checked={usePvgis}
              ...
              {!usePvgis && (
                <Form.Group className="mb-3">
                  ...
                  >
                    <option value="hopetown_14_15">
                      Hopetown Azth:14 Tilt:15
                    </option>
                    <option value="midrand_ew_5">
                      Midrand Azth:east-west Tilt:5
                    </option>
                    <option value="pvlib_hopetown_0_15">
                      Pvlib Hopetown Azth:0 Tilt:15
                    </option>
                    <option value="pvlib_hopetown_0_15_0.9">
                      Pvlib Hopetown (x0.9) Azth:0 Tilt:15
                    </option>
                  </Form.Select>
                </Form.Group>
              )}
                  ...
                  <Col md={6}>
                    <Form.Group className="mb-3">
                      ...
                      <Form.Control
                        ...
                        value={design.tilt}
                        onChange={(e) =>
                          onDesignChange({ ...design, tilt: e.target.value })
                        }
                        placeholder="e.g., 15"
                      />
                    </Form.Group>
                  ...
                  <Col md={6}>
                    <Form.Group className="mb-3">
                      ...
                      <Form.Control
                        ...
                        onChange={(e) =>
                          onDesignChange({ ...design, azimuth: e.target.value })
                        }
                ...
                <Col md={12}>
                  <Form.Group className="mb-3">
                    ...
                    <Select
                      ...
                      onChange={(opt) =>
                        handleSelectChange("selectedPanel", opt)
                      }
                      isClearable
              ...
              <Row>
                <Col md={6}>
                  <Form.Group>
                    ...
                    <Select
                      options={products.inverters.map((p) => ({
                        value: p.id,
                        label: `${p.brand} ${p.model} (${p.rating_kva}kVA)`,
                      }))}
                      value={design.selectedInverter}
                      onChange={(opt) =>
                        handleSelectChange("selectedInverter", opt)
                      }
                      isClearable
                    />
                  </Form.Group>
                  <Form.Group className="mt-2">
                    ...
                    <Form.Control
                      ...
                      onChange={(e) =>
                        onDesignChange({
                          ...design,
                          inverterQuantity: e.target.value,
                        })
                      }
                      onBlur={(e) =>
                        onDesignChange({
                          ...design,
                          inverterQuantity: Math.max(
                            1,
                ...
                <Col md={6}>
                  <Form.Group>
                    ...
                    <Select
                      isDisabled={design.systemType === "grid"}
                      options={products.batteries.map((p) => ({
                        value: p.id,
                        label: `${p.brand} ${p.model} (${p.capacity_kwh}kWh)`,
                      }))}
                      value={design.selectedBattery}
                      onChange={(opt) =>
                        handleSelectChange("selectedBattery", opt)
                      }
                      isClearable
                    />
                  </Form.Group>
                      ...
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          onChange={(e) =>
                            onDesignChange({
                              ...design,
                              batteryQuantity: e.target.value,
                            })
                          }
                          onBlur={(e) =>
                            onDesignChange({
                              ...design,
                              batteryQuantity: Math.max(
                                1,
                                parseInt(e.target.value) || 1
                              ),
                            })
                      ...
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          onChange={(e) =>
                            onDesignChange({
                              ...design,
                              batterySocLimit: e.target.value,
                            })
                          }
                          onBlur={(e) =>
                            onDesignChange({
                              ...design,
                              batterySocLimit: Math.max(
                                0,
                ...
                <Row className="g-3">
                    ...
                    <Form.Group>
                      ...
                      <Form.Check
                        ...
                        onChange={(e) =>
                          onDesignChange({
                            ...design,
                            generatorEnabled: e.target.checked,
                          })
                        }
                  ...
                  <Col md={4}>
                    <Form.Group>
                      ...
                      <Select
                        value={GENERATOR_SIZES.find(
                          (s) => s.value === design.generatorKva
                        )}
                        onChange={(option) =>
                          onDesignChange({
                            ...design,
                            generatorKva: option.value,
                          })
                        }
                    ...
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        onChange={(e) =>
                          onDesignChange({
                            ...design,
                            generatorMinLoading: e.target.value,
                          })
                        }
                    ...
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        onChange={(e) =>
                          onDesignChange({
                            ...design,
                            generatorMinRunTime: e.target.value,
                          })
                        }
                        disabled={!design.generatorEnabled}
                      />
                    ...
                    <Form.Group className="mt-md-4">
                      <Form.Check
                        ...
                        onChange={(e) =>
                          onDesignChange({
                            ...design,
                            generatorChargeBattery: e.target.checked,
                          })
                        }
                        disabled={!design.generatorEnabled}
                      />
                    ...
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        onChange={(e) =>
                          onDesignChange({
                            ...design,
                            generatorBatteryStartSoc: e.target.value,
                          })
                        }
                        disabled={!design.generatorEnabled}
                        placeholder="e.g., 20"
                    ...
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        onChange={(e) =>
                          onDesignChange({
                            ...design,
                            generatorBatteryStopSoc: e.target.value,
                          })
                        }
                        disabled={!design.generatorEnabled}
                        placeholder="e.g., 90"
                    ...
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        onChange={(e) =>
                          onDesignChange({
                            ...design,
                            generatorServiceCost: e.target.value,
                          })
                        }
                        disabled={!design.generatorEnabled}
                    ...
                    <Form.Group>
                      ...
                      <Form.Control
                        ...
                        onChange={(e) =>
                          onDesignChange({
                            ...design,
                            generatorServiceInterval: e.target.value,
                          })
                        }
                        disabled={!design.generatorEnabled}
                        placeholder="e.g., 1000"
  ...
  if (!templates || templates.length === 0) {
    return (
      <Alert variant="info" className="my-4">
        ...
        <p>
          There are no standard designs available. You can create a design in
          the System Builder Tool.
        </p>
      </Alert>
    );
  }
...
const formatSystemType = (type) => {
  ...
  return (
    type.charAt(0).toUpperCase() + type.slice(1).toLowerCase().replace("-", " ")
  );
};
...
const getFuelConsumption = (generatorSizeKw, loadFactor) => {
  ...
  const FUEL_TABLE = [
    { size_kw: 20, lph: { 0.25: 2.3, 0.5: 3.4, 0.75: 4.9, 1.0: 6.1 } },
    { size_kw: 30, lph: { 0.25: 4.9, 0.5: 6.8, 0.75: 9.1, 1.0: 10.0 } },
    { size_kw: 40, lph: { 0.25: 6.1, 0.5: 8.7, 0.75: 12.0, 1.0: 15.0 } },
    { size_kw: 50, lph: { 0.25: 6.45, 0.5: 9.8, 0.75: 13.15, 1.0: 16.85 } },
    { size_kw: 60, lph: { 0.25: 6.8, 0.5: 10.9, 0.75: 14.3, 1.0: 18.7 } },
    { size_kw: 75, lph: { 0.25: 9.1, 0.5: 12.8, 0.75: 17.4, 1.0: 23.0 } },
    { size_kw: 100, lph: { 0.25: 9.8, 0.5: 15.5, 0.75: 21.9, 1.0: 28.0 } },
    { size_kw: 125, lph: { 0.25: 11.7, 0.5: 18.9, 0.75: 26.8, 1.0: 34.4 } },
    { size_kw: 135, lph: { 0.25: 12.4, 0.5: 20.4, 0.75: 28.7, 1.0: 37.0 } },
    { size_kw: 150, lph: { 0.25: 13.6, 0.5: 22.3, 0.75: 31.7, 1.0: 41.2 } },
    { size_kw: 175, lph: { 0.25: 15.5, 0.5: 25.7, 0.75: 36.7, 1.0: 48.0 } },
    { size_kw: 200, lph: { 0.25: 17.7, 0.5: 29.1, 0.75: 41.6, 1.0: 54.5 } },
    { size_kw: 230, lph: { 0.25: 20.0, 0.5: 33.3, 0.75: 47.3, 1.0: 62.8 } },
    { size_kw: 250, lph: { 0.25: 21.5, 0.5: 35.9, 0.75: 51.4, 1.0: 68.1 } },
    { size_kw: 300, lph: { 0.25: 25.7, 0.5: 42.7, 0.75: 60.9, 1.0: 81.3 } },
    { size_kw: 350, lph: { 0.25: 29.9, 0.5: 49.5, 0.75: 70.7, 1.0: 95.0 } },
    { size_kw: 400, lph: { 0.25: 33.6, 0.5: 56.4, 0.75: 80.6, 1.0: 108.2 } },
    { size_kw: 500, lph: { 0.25: 41.6, 0.5: 70.0, 0.75: 99.9, 1.0: 135.1 } },
    { size_kw: 600, lph: { 0.25: 49.9, 0.5: 83.2, 0.75: 119.2, 1.0: 182.4 } },
    { size_kw: 750, lph: { 0.25: 61.7, 0.5: 103.7, 0.75: 148.7, 1.0: 202.1 } },
    { size_kw: 1000, lph: { 0.25: 81.7, 0.5: 137.7, 0.75: 197.2, 1.0: 269.1 } },
    {
      size_kw: 1250,
      lph: { 0.25: 101.8, 0.5: 171.4, 0.75: 246.0, 1.0: 336.1 },
    },
    {
      size_kw: 1500,
      lph: { 0.25: 121.8, 0.5: 205.5, 0.75: 294.5, 1.0: 403.1 },
    },
    {
      size_kw: 1750,
      lph: { 0.25: 141.9, 0.5: 273.0, 0.75: 343.3, 1.0: 470.1 },
    },
    {
      size_kw: 2000,
      lph: { 0.25: 162.0, 0.5: 273.3, 0.75: 391.7, 1.0: 537.1 },
    },
  ];
  ...
  const fuelData = FUEL_TABLE.find(
    (entry) => entry.size_kw === generatorSizeKw
  );
  if (!fuelData) {
    ...
    const closestSize = sortedSizes.reduce((prev, curr) =>
      Math.abs(curr - generatorSizeKw) < Math.abs(prev - generatorSizeKw)
        ? curr
        : prev
    );
...
const interpolateFuelConsumption = (lphData, loadFactor) => {
  ...
  if (loadFactor <= 0.5) {
    ...
    return lphData[0.25] + factor * (lphData[0.5] - lphData[0.25]);
  }
  if (loadFactor <= 0.75) {
    const factor = (loadFactor - 0.5) / 0.25;
    return lphData[0.5] + factor * (lphData[0.75] - lphData[0.5]);
  }
  if (loadFactor <= 1.0) {
    const factor = (loadFactor - 0.75) / 0.25;
    return lphData[0.75] + factor * (lphData[1.0] - lphData[0.75]);
  }
  // Over 100% load - extrapolate
  return lphData[1.0] * loadFactor;
};
...
function SystemDesign({ projectId }) {
    ...
    if (cached) {
      try {
        ...
        return {
          ...
          generatorMinLoading:
            parsed.generatorMinLoading ?? initial.generatorMinLoading,
          generatorChargeBattery:
            parsed.generatorChargeBattery ?? initial.generatorChargeBattery,
          dieselPrice: parsed.dieselPrice ?? initial.dieselPrice,
          generatorMinRunTime:
            parsed.generatorMinRunTime ?? initial.generatorMinRunTime,
          generatorBatteryStartSoc:
            parsed.generatorBatteryStartSoc ?? initial.generatorBatteryStartSoc,
          generatorBatteryStopSoc:
            parsed.generatorBatteryStopSoc ?? initial.generatorBatteryStopSoc,
          generatorServiceCost:
            parsed.generatorServiceCost ?? initial.generatorServiceCost,
          generatorServiceInterval:
            parsed.generatorServiceInterval ?? initial.generatorServiceInterval,
        };
      } catch (err) {
        console.error(
          "Failed to parse cached generator settings in initializer:",
          err
        );
  ...
  useEffect(() => {
    ...
    axios
      .get(`${API_URL}/api/system_templates`)
      .then((res) => {
  ...
  useEffect(() => {
    ...
    sessionStorage.setItem(
      `generatorSettings_${projectId}`,
      JSON.stringify(generatorSettings)
    );
  }, [
    projectId,
    design.generatorEnabled,
    design.generatorKva,
    design.generatorMinLoading,
    design.generatorChargeBattery,
    design.dieselPrice,
    design.generatorMinRunTime,
    design.generatorBatteryStartSoc,
    design.generatorBatteryStopSoc,
    design.generatorServiceCost,
    design.generatorServiceInterval,
  ]);
  ...
  useEffect(() => {
    ...
    if (coreComponentsData) {
      ...
      try {
        ...
        console.log(
          "Loading core components from quote instead of project data:",
          coreComponents
        );
        ...
        if (coreComponents.panel) {
          const panelProduct = products.panels.find(
            (p) => p.id === coreComponents.panel.id
          );
          if (panelProduct) {
            ...
            updates.panelKw = (
              (coreComponents.panel.quantity *
                (panelProduct.power_w || PANEL_WATTAGE)) /
              1000
            ).toFixed(2);
        ...
        if (coreComponents.inverter) {
          console.log(
            "Looking for inverter with ID:",
            coreComponents.inverter.id,
            "in products:",
            products.inverters.length,
            "inverters"
          );
          const inverterProduct = products.inverters.find(
            (p) => p.id === coreComponents.inverter.id
          );
          ...
          if (inverterProduct) {
            ...
            console.log(
              ...
              updates.selectedInverter,
              "quantity:",
              updates.inverterQuantity
            );
          } else {
            console.warn(
              "Inverter product not found with ID:",
              coreComponents.inverter.id
            );
          }
        }
        ...
        if (coreComponents.battery) {
          const batteryProduct = products.batteries.find(
            (p) => p.id === coreComponents.battery.id
          );
          if (batteryProduct) {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (p.from_standard_template || p.template_id) {
          console.log(
            "Loading project from standard template:",
            p.template_name
          );
        ...
        const inverterInfo =
          p.inverter_kva && typeof p.inverter_kva === "object"
            ? p.inverter_kva
            : { model: null, capacity: p.inverter_kva, quantity: 1 };
        const currentInverter = inverterInfo.model
          ? products.inverters.find((inv) => inv.model === inverterInfo.model)
          : null;

        // Find the full product object for the saved battery
        const batteryInfo =
          p.battery_kwh && typeof p.battery_kwh === "object"
            ? p.battery_kwh
            : { model: null, capacity: p.battery_kwh, quantity: 1 };
        const currentBattery = products.batteries.find(
          (bat) => bat.model === batteryInfo.model
        );
        ...
        setDesign((prevDesign) => ({
          ...
          selectedPanel: currentPanel
            ? {
                ...
                label: `${currentPanel.brand} ${currentPanel.model}`,
                product: currentPanel,
              }
            : null,
          selectedInverter: currentInverter
            ? {
                value: currentInverter.id,
                label: `${currentInverter.model} (${currentInverter.rating_kva}kVA)`,
                product: currentInverter,
              }
            : null,
          ...
          selectedBattery: currentBattery
            ? {
                ...
                label: `${currentBattery.model} (${currentBattery.capacity_kwh}kWh)`,
                product: currentBattery,
              }
            : null,
        ...
        if (res.data.generator_config) {
          ...
          setDesign((prevDesign) => ({
            ...
            generatorChargeBattery:
              gen.can_charge_battery !== undefined
                ? gen.can_charge_battery
                : true,
  ...
  const handleSelectTemplate = (template) => {
    ...
    const selectedPanel = panelComponent
      ? products.panels.find((p) => p.id === panelComponent.product_id)
      : null;
    const selectedInverter = inverterComponent
      ? products.inverters.find((p) => p.id === inverterComponent.product_id)
      : null;
    const selectedBattery = batteryComponent
      ? products.batteries.find((p) => p.id === batteryComponent.product_id)
      : null;
    ...
    const calculatedPanelKw =
      selectedPanel && panelQuantity > 0
        ? (selectedPanel.power_w * panelQuantity) / 1000
        : 0;
    ...
    setTimeout(() => {
      ...
      const savePayload = {
        ...
        inverter_kva: newDesignData.selectedInverter
          ...
          : null,
        inverter_ids: newDesignData.selectedInverter
          ? [newDesignData.selectedInverter.product.id]
          : [],
        battery_kwh:
          newDesignData.systemType !== "grid" && newDesignData.selectedBattery
            ? {
        ...
        battery_ids:
          newDesignData.systemType !== "grid" && newDesignData.selectedBattery
            ? [newDesignData.selectedBattery.product.id]
            : [],
        use_pvgis: usePvgis,
      ...
      axios
        .put(`${API_URL}/api/projects/${projectId}`, savePayload)
        .then(() => {
        ...
        .then(() => {
          ...
          const simPayload = {
            ...
            system: {
              ...
              system_type: newDesignData.systemType,
              inverter_kva:
                (newDesignData.selectedInverter?.product?.rating_kva || 0) *
                newDesignData.inverterQuantity,
              battery_kwh:
                (newDesignData.selectedBattery?.product?.capacity_kwh || 0) *
                newDesignData.batteryQuantity,
              allow_export: newDesignData.allowExport,
              battery_soc_limit: newDesignData.batterySocLimit,

              generator: {
                enabled:
                  newDesignData.systemType === "off-grid" &&
                  !!design.generatorEnabled,
                ...
                diesel_price_r_per_liter: parseFloat(
                  design.dieselPrice || 23.5
                ),
                min_run_time_hours: parseFloat(
                  design.generatorMinRunTime || 1.0
                ),
                battery_start_soc: parseFloat(
                  design.generatorBatteryStartSoc || 20
                ),
                battery_stop_soc: parseFloat(
                  design.generatorBatteryStopSoc || 100
                ),
                service_cost: parseFloat(design.generatorServiceCost || 1000),
                service_interval_hours: parseFloat(
                  design.generatorServiceInterval || 1000
                ),
              },
            },
          };
        ...
        .then((res) => {
          ...
          showNotification(
            "Standard system applied, saved, and simulated!",
            "success"
          );
        })
        .catch((err) => {
          const errorMsg =
            ...
            "Failed to save or simulate the system.";
  ...
  useEffect(() => {
    if (simulationData?.timestamps?.length > 0) {
      ...
      const rawLast = new Date(
        simulationData.timestamps[simulationData.timestamps.length - 1]
      );
      const lastDayEnd = toEndOfDay(rawLast);

      // We want an inclusive 7 day window: day 0 .. day 6
      const desiredEnd = new Date(
        firstDayStart.getTime() + 6 * 24 * 60 * 60 * 1000
      );
  ...
  const chartData = useMemo(() => {
    ...
    const startIndex = sim.timestamps.findIndex(
    ...
    const pv_potential = sim.potential_generation
      ? sim.potential_generation.slice(startIndex, endIndex)
      : [];
    const generator_kw = sim.generator_kw
      ? sim.generator_kw.slice(startIndex, endIndex)
      : [];
  ...
  const chartDataAverage = useMemo(() => {
    ...
    if (rangeDays > 90) {
      ...
      console.log(
        "Downsampling data for better performance - showing daily averages"
      );
      ...
      for (let i = startIndex; i < endIndex; i++) {
        ...
        dailyData[dayKey].potArr.push(
          (sim.potential_generation
            ? sim.potential_generation[i]
            : sim.generation[i]) || 0
        );
        dailyData[dayKey].generator +=
          (sim.generator_kw ? sim.generator_kw[i] : 0) || 0;
      }
      ...
      pv_potential = sim.potential_generation
        ? sim.potential_generation.slice(startIndex, endIndex)
        : [];
      generator_kw = sim.generator_kw
        ? sim.generator_kw.slice(startIndex, endIndex)
        : [];
    }
  ...
  const chartOptions = useMemo(() => {
    ...
    const targetSamples = Math.min(
      1200,
      Math.max(600, Math.round(rangeDays * 3))
    );
    ...
    () => ({
      ...
      scales: {
        x: {
          type: "time",
          time: {
            unit: rangeDays > 90 ? "month" : rangeDays > 30 ? "week" : "day",
  ...
  const saveProject = (payload) => {
    return axios
      .put(`${API_URL}/api/projects/${projectId}`, payload)
      .then(() => {
        showNotification("System saved to project 👍", "success");
      })
      .catch((err) => {
        const errorMsg =
          err.response?.data?.error || "Could not save the system.";
        showNotification(errorMsg, "danger");
      });
  };
    ...
    try {
      ...
      const savePayload = {
        ...
        inverter_kva: design.selectedInverter
          ...
          : null,
        battery_kwh:
          design.systemType !== "grid" && design.selectedBattery
            ? {
      ...
      await axios.post(
        `${API_URL}/api/projects/${projectId}/bom/clear-template-extras`
      );
      ...
      showNotification(
        "Stopped using template. Core components retained.",
        "success"
      );
    } catch (err) {
  ...
  const handleResetToTemplate = async () => {
    try {
      ...
      const res = await axios.get(
        `${API_URL}/api/system_templates/${standardTemplateInfo.id}`
      );
  ...
  const handleSimulate = () => {
    ...
    const savePayload = {
      ...
      use_pvgis: usePvgis,
      generation_profile_name: profileName,
      inverter_ids: design.selectedInverter
    ...
    saveProject(savePayload)
      .then(() => {
        ...
        const simPayload = {
          ...
          system: {
            ...
            inverter_kva:
              (design.selectedInverter?.product.rating_kva || 0) *
              design.inverterQuantity,
            battery_kwh:
              (design.selectedBattery?.product.capacity_kwh || 0) *
              design.batteryQuantity,
            allow_export: design.allowExport,
            battery_soc_limit: design.batterySocLimit,

            generator: {
              enabled:
                design.systemType === "off-grid" && !!design.generatorEnabled,
              kva: parseFloat(design.generatorKva || 0),
              min_loading_pct: parseFloat(design.generatorMinLoading || 25),
              can_charge_battery: !!design.generatorChargeBattery,
              diesel_price_r_per_liter: parseFloat(design.dieselPrice || 23.5),
      ...
      .catch((err) => {
        const errorMsg =
          err.response?.data?.error ||
          "Failed to save system or run simulation.";
        showNotification(errorMsg, "danger");
      })
  ...
  const filteredData = useMemo(() => {
    ...
    simulationData.timestamps.forEach((ts, i) => {
      ...
      if (timestamp >= startMoment && timestamp <= endMoment) {
        ...
        filtered.potential_generation.push(
          simulationData.potential_generation[i]
        );

        // These fields might not exist in all system types
        if (simulationData.generator_kw)
          filtered.generator_kw.push(simulationData.generator_kw[i] || 0);
        if (simulationData.shortfall_kw)
          filtered.shortfall_kw.push(simulationData.shortfall_kw[i] || 0);
      }
    });
  ...
  useEffect(() => {
    ...
    const totalConsumption = filteredData.demand.reduce(
      (sum, demand) => sum + demand * timeIntervalHours,
      0
    );
    const totalPotentialGenKwh = filteredData.potential_generation.reduce(
      (sum, val) => sum + val * timeIntervalHours,
      0
    );
    const totalUtlizedGenKwh = filteredData.generation.reduce(
      (sum, val) => sum + val * timeIntervalHours,
      0
    );
    const totalImportKwh = filteredData.import_from_grid.reduce(
      (sum, val) => sum + val * timeIntervalHours,
      0
    );
    const totalExportKwh = filteredData.export_to_grid.reduce(
      (sum, val) => sum + val * timeIntervalHours,
      0
    );
    const pvUsedOnSiteKwh = totalUtlizedGenKwh - totalExportKwh;
    const pvUtilizationPct =
      totalUtlizedGenKwh > 0
        ? (pvUsedOnSiteKwh / totalPotentialGenKwh) * 100
        : 0;
    const totalShortfallKwh = filteredData.shortfall_kw.reduce(
      (sum, val) => sum + val * timeIntervalHours,
      0
    );
    const totalGenKwh = filteredData.generator_kw.reduce(
      (sum, val) => sum + val * timeIntervalHours,
      0
    );
    ...
    if (design.systemType === "off-grid" && design.generatorEnabled) {
      ...
      const dieselPrice = parseFloat(design.dieselPrice || 23.5);
      const serviceCost = parseFloat(design.generatorServiceCost || 1000);
      const serviceInterval = parseFloat(
        design.generatorServiceInterval || 1000
      );
      ...
      const serviceCostForPeriod =
        (totalRunningHours / serviceInterval) * serviceCost;
    ...
    design.generatorServiceCost,
    design.generatorServiceInterval,
  ]); // Re-calculate if filtered data or design changes

  // For Annual Metrics
  useEffect(() => {
    if (
      !simulationData ||
      !simulationData.timestamps ||
      simulationData.timestamps.length === 0 ||
      !simulationData.annual_metrics
    )
      return;
    ...
    setAnnualMetrics({
      ...
      specificYieldWithThrottling:
        metrics.specific_yield_incl_losses.toFixed(2),
      specificYieldExclThrottling:
        metrics.specific_yield_excl_losses.toFixed(2),
  ...
  return (
    <>
      <LoadingOverlay
        show={isLoading}
        message={
          simulationLoading ? "Running simulation..." : "Loading data..."
        }
      />
      <div className="mb-4">
        <Card className="shadow-sm border-0">
          <Card.Body>
            ...
            <div className="d-flex gap-3">
              <Button
                variant={
                  designMode === "custom" ? "primary" : "outline-primary"
                }
              ...
              <Button
                variant={
                  designMode === "standard" ? "primary" : "outline-primary"
                }
        ...
        <Alert variant="success" className="d-flex align-items-center mb-4">
          <div className="d-flex align-items-center flex-grow-1">
            ...
            <div>
              ...
              <div>
                You're using "{standardTemplateInfo?.name}" template as a
                starting point
              </div>
            </div>
          </div>
      ...
      {simulationData && startDate && (
        <div className="mt-5">
          <Card className="shadow-sm my-4">
            ...
            >
              <span>
                <i className="bi bi-bar-chart-line-fill me-2"></i>Simulation
                Results
              </span>
              <div className="d-flex align-items-center">
                ...
                >
                  <i
                    className={`bi ${showLosses ? "bi-eye-slash-fill" : "bi-eye-fill"} me-2`}
                  ></i>
                ...
                >
                  <i
                    className={`bi ${showAverages ? "bi-eye-slash-fill" : "bi-eye-fill"} me-2`}
                  ></i>
                  {showAverages
                    ? "Hide Averages (for full year)"
                    : "Show Averages (for full year)"}
                </Button>
              </div>
              ...
              <div className="date-picker-container">
                ...
                <DatePicker
                  ...
                  minDate={
                    simulationData?.timestamps &&
                    new Date(simulationData.timestamps[0])
                  }
                  maxDate={
                    simulationData?.timestamps &&
                    new Date(
                      simulationData.timestamps[
                        simulationData.timestamps.length - 1
                      ]
                    )
                  }
                />
          ...
          {Number(metrics.energyShortfall || 0) > 0 && (
            <Alert variant="danger" className="mb-3">
              ...
              This off-grid design has <b>{metrics.energyShortfall} kWh</b> of
              energy shortfall. Consider adding PV/battery capacity.
            </Alert>
          )}
          ...
          <Row className="mb-4 g-3 mt-4">
            ...
            <Col md={4} lg>
              <Card className="border-start border-4 border-success bg-white shadow-sm rounded p-3 h-100">
                ...
                <div className="fs-4 fw-bold">
                  {metrics.utilizedPVGeneration} kWh
                </div>
              </Card>
            </Col>
            <Col md={4} lg>
                  ...
                  <Row>
                    <Col xs={6}>
                      ...
                      <div className="fs-6 fw-bold mb-1">
                        {metrics.generatorEnergy || 0} kWh
                      </div>
                    </Col>
                    <Col xs={6}>
                      <div className="text-muted small">Total Cost</div>
                      <div className="fs-6 fw-bold mb-1">
                        R {(metrics.dieselCost || 0).toLocaleString()}
                      </div>
                    </Col>
                  </Row>
                </Card>
          ...
          {simulationData &&
            ...
            (() => {
              ...
              const timeIntervalHours = 0.5;
              const annualGenKwh =
                simulationData.generator_kw?.reduce(
                  (sum, val) => sum + val * timeIntervalHours,
                  0
                ) || 0;
              ...
              const serviceCost = parseFloat(
                design.generatorServiceCost || 1000
              );
              const serviceInterval = parseFloat(
                design.generatorServiceInterval || 1000
              );
              ...
              simulationData.generator_kw?.forEach((genKw) => {
                if (genKw > 0 && generatorSizeKw > 0) {
                  const loadFactor = genKw / generatorSizeKw;
                  const fuelRateLph = getFuelConsumption(
                    generatorSizeKw,
                    loadFactor
                  );
              ...
              const annualServiceCost =
                (totalAnnualRunningHours / serviceInterval) * serviceCost;
              const annualTotalCost = annualFuelCost + annualServiceCost;

              return (
                <Card className="shadow-sm mt-3">
                  <Card.Header as="h5">
                    <i className="bi bi-fuel-pump me-2"></i>Generator
                    Performance Analysis - {design.generatorKva}kW Generator
                  </Card.Header>
                  <Card.Body>
                    {/* <Row className="mb-3">
                            <Col md={6}>
                    ...
                    <Row className="mb-3">
                      <Col md={6}>
                        <div className="text-muted small">
                          Annual Generator Energy
                        </div>
                        <div className="fs-5 fw-bold text-primary">
                          {Math.round(annualGenKwh)} kWh/year
                        </div>
                      </Col>
                      <Col md={6}>
                        <div className="text-muted small">
                        ...
                        <div className="fs-5 fw-bold text-primary">
                          R {Math.round(annualTotalCost).toLocaleString()}/year
                        </div>
                      </Col>
                    </Row>

                    <h6 className="mt-4 mb-3">
                      Generator Efficiency by Load Factor
                    </h6>
                      ...
                      <Table size="sm" striped hover>
                        ...
                        <tbody>
                          {[25, 50, 75, 100].map((loadPct) => {
                            const generatorSizeKw =
                              parseFloat(design.generatorKva) || 0;
                            const dieselPriceRPerL =
                              parseFloat(design.dieselPrice) || 23.5;
                            const serviceCost =
                              parseFloat(design.generatorServiceCost) || 1000;
                            const serviceInterval =
                              parseFloat(design.generatorServiceInterval) ||
                              1000;
                            ...
                            const fuelCostPerHour =
                              fuelRateLph * dieselPriceRPerL;
                            const serviceCostPerHour =
                              serviceCost / serviceInterval; // R per hour for service
                            const totalRunningCostPerHour =
                              fuelCostPerHour + serviceCostPerHour;
                            const totalCostPerKwh =
                              outputKw > 0
                                ? totalRunningCostPerHour / outputKw
                                : 0;
                            ...
                            return (
                              <tr key={loadPct}>
                                ...
                                <td>
                                  R {totalRunningCostPerHour.toFixed(2)}/h
                                </td>
                      ...
                      <Table size="sm" striped hover className="mb-0">
                        ...
                        <tbody>
                          {(() => {
                            ...
                            const generatorKwData =
                              simulationData.generator_kw || [];
                            const activeGeneratorData = generatorKwData.filter(
                              (kw) => kw > 0
                            );
                            const averageDemand =
                              activeGeneratorData.length > 0
                                ? activeGeneratorData.reduce(
                                    (sum, kw) => sum + kw,
                                    0
                                  ) / activeGeneratorData.length
                                : 0;

                            // Calculate load percentage
                            const loadPercentage =
                              generatorSizeKw > 0
                                ? averageDemand / generatorSizeKw
                                : 0;
                            const loadFactor = Math.min(
                              1.0,
                              Math.max(0.25, loadPercentage)
                            ...
                            const fuelCostPerHour =
                              fuelRateLph * dieselPriceRPerL;
                            const serviceCostPerHour =
                              serviceCost / serviceInterval;

                            // Get 100% load R/kWh for comparison
                            const fuelRateAt100pct = getFuelConsumption(
                              generatorSizeKw,
                              1.0
                            );
                            const costPerKwhAt100pct =
                              generatorSizeKw > 0
                                ? (fuelRateAt100pct * dieselPriceRPerL) /
                                  generatorSizeKw
                                : 0;

                            // Calculate cost per kWh (excl service)
                            const calculatedCostPerKwh =
                              averageDemand > 0
                                ? fuelCostPerHour / averageDemand
                                : 0;
                            const costPerKwhExclService =
                              calculatedCostPerKwh < costPerKwhAt100pct
                                ? costPerKwhAt100pct
                                : calculatedCostPerKwh;

                            // Calculate cost per kWh (incl service)
                            const totalCostPerHour =
                              fuelCostPerHour + serviceCostPerHour;
                            const calculatedTotalCostPerKwh =
                              averageDemand > 0
                                ? totalCostPerHour / averageDemand
                                : 0;
                            const totalCostPerKwhAt100pct =
                              generatorSizeKw > 0
                                ? (fuelRateAt100pct * dieselPriceRPerL +
                                    serviceCostPerHour) /
                                  generatorSizeKw
                                : 0;
                            const costPerKwhInclService =
                              calculatedTotalCostPerKwh <
                              totalCostPerKwhAt100pct
                                ? totalCostPerKwhAt100pct
                                : calculatedTotalCostPerKwh;
                            ...
                            return (
                              <>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <strong>
                                      R {costPerKwhExclService.toFixed(2)}/kWh
                                    </strong>
                                  </td>
                                </tr>
                                <tr>
                                  ...
                                  <td>
                                    <strong>
                                      R {costPerKwhInclService.toFixed(2)}/kWh
                                    </strong>
                                  </td>
                                </tr>
                              </>
      ...
      <Modal
        show={showStopTemplateModal}
        onHide={() => setShowStopTemplateModal(false)}
        centered
      >
        ...
        <Modal.Body className="pt-0">
          <div className="mb-3">
            <p className="text-muted mb-3">
              Are you sure you want to stop using the template "
              <strong>{standardTemplateInfo?.name}</strong>"?
            </p>
            <div className="bg-light rounded p-3">
              ...
              <ul className="list-unstyled mb-3 ps-3">
                <li>
                  <i className="bi bi-dot text-success"></i>Panels, inverters,
                  and batteries
                </li>
              </ul>
              ...
              <ul className="list-unstyled mb-0 ps-3">
                <li>
                  <i className="bi bi-dot text-danger"></i>All other template
                  components from BOM
                </li>
              </ul>
            </div>
      ...
      <Modal
        show={showResetTemplateModal}
        onHide={() => setShowResetTemplateModal(false)}
        centered
      >
        <Modal.Header closeButton className="border-0 pb-0">
          <Modal.Title className="d-flex align-items-center">
        ...
        <Modal.Body className="pt-0">
          <div className="mb-3">
            <p className="text-muted mb-3">
              Are you sure you want to reset to the original template:{" "}
              <strong>{standardTemplateInfo?.name}</strong>
            </p>
            <div className="bg-light rounded p-3">
              ...
              <ul className="list-unstyled mb-0 ps-3">
                <li>
                  <i className="bi bi-dot text-danger"></i>Discard all your
                  custom changes
                </li>
                <li>
                  <i className="bi bi-dot text-success"></i>Reset BOM to
                  original template
                </li>
              </ul>
            </div>
