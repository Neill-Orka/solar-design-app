...
def add_client():
    ...
    try:
        address = data.get(
            "address",
            {"street": "", "town": "", "province": "", "country": "South Africa"},
        )
        ...
        return (
            jsonify(
                {"message": "Client added successfully!", "client_id": new_client.id}
            ),
            200,
        )
...
def update_client(client_id):
    try:
        ...
        client.vat_number = data.get("vat_number", client.vat_number)
